...
public class ArrayMax_07 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int num = Integer.parseInt(reader.readLine()); //вводим количесвто элементов в массиве
        //проверка правильности введенного числа
        while (true) {
            if (num <= 0 || num % 2 != 0 || num >= Integer.MAX_VALUE) {
        ...
        System.out.println("Исходный массив array[" + num + "]: " + Arrays.toString(array));
